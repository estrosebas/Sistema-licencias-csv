...
public class Establecimiento {
    ...
    private int Area_Estab;
    private String Tipo_Licencia;

    public Establecimiento(String Ruc_Estab, String Giro_Actividad, int Area_Estab, String Tipo_Licencia) {
    ...
    public Establecimiento(String departamento, String provincia, String distrito, String ubigeo, String Gobierno_Local, String Ruc_Estab, String Giro_Actividad, int Area_Estab, String Tipo_Licencia) {
    ...
    public int getArea_Estab() {
        return Area_Estab;
    }

    public void setArea_Estab(int Area_Estab) {
        this.Area_Estab = Area_Estab;
    }
